...
fn launch_play_flow(
    ...
    let mesh_manifest = format!(
        r#"{{"schema":"oathyard.wgpu_runtime_mesh_manifest.v1","source":"oathyard play Unit-085 direct executable mesh manifest","capture_id":"play_windowed","candidate_renderer_only":false,"material_separation_classes":["fighter_body","armor_clothing","weapon_metal","arena_stone_ground"],"presentation_material_fallback":"source-approved runtime texture paths","production_seed_render":true,"production_ready":false,"truth_mutation":false,"meshes":[{{"mesh_asset_id":"player_{pfn}","mesh_asset_class":"fighter","mesh_source":"{pfs}","translation":[-0.72,0.0,0.0],"scale":0.95,"yaw_radians":0.10,"base_color_texture_path":"{pf_tb}","normal_texture_path":"{pf_tn}","orm_texture_path":"{pf_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}},{{"mesh_asset_id":"opponent_{ofn}","mesh_asset_class":"fighter","mesh_source":"{ofs}","translation":[0.72,0.0,0.0],"scale":0.95,"yaw_radians":0.10,"base_color_texture_path":"{of_tb}","normal_texture_path":"{of_tn}","orm_texture_path":"{of_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}},{{"mesh_asset_id":"player_{pan}","mesh_asset_class":"armor","mesh_source":"{pas}","translation":[-0.72,0.18,0.0],"scale":0.22,"yaw_radians":0.10,"base_color_texture_path":"{pa_tb}","normal_texture_path":"{pa_tn}","orm_texture_path":"{pa_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}},{{"mesh_asset_id":"opponent_{oan}","mesh_asset_class":"armor","mesh_source":"{oas}","translation":[0.72,0.18,0.0],"scale":0.22,"yaw_radians":0.10,"base_color_texture_path":"{oa_tb}","normal_texture_path":"{oa_tn}","orm_texture_path":"{oa_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}},{{"mesh_asset_id":"player_{pwn}","mesh_asset_class":"weapon","mesh_source":"{pws}","translation":[-1.02,0.42,-0.04],"scale":0.38,"yaw_radians":1.35,"base_color_texture_path":"{pw_tb}","normal_texture_path":"{pw_tn}","orm_texture_path":"{pw_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}},{{"mesh_asset_id":"opponent_{own}","mesh_asset_class":"weapon","mesh_source":"{ows}","translation":[1.02,0.42,-0.04],"scale":0.38,"yaw_radians":-1.35,"base_color_texture_path":"{ow_tb}","normal_texture_path":"{ow_tn}","orm_texture_path":"{ow_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}},{{"mesh_asset_id":"{an}","mesh_asset_class":"arena","mesh_source":"{ars}","translation":[0.0,-0.30,0.35],"scale":0.50,"yaw_radians":0.0,"base_color_texture_path":"{ar_tb}","normal_texture_path":"{ar_tn}","orm_texture_path":"{ar_to}","candidate_status":"source_approved_production_seed","production_ready":false,"truth_mutation":false}}]}}"#,
