...
fn camera_for_mode(mode: &str) -> CameraMode {
    match mode {
        ...
        // Unit-106: First-person cameras for live duel fidelity.
        // eye is at player fighter position (x=-0.72) looking at opponent (x=0.72).
        "first_person_combat_view" => CameraMode { eye: [-0.72, 1.5, 0.5], look_at: [0.72, 1.0, 0.0], fov_radians: 0.85 },
        "first_person_anticipation" => CameraMode { eye: [-0.72, 1.5, 0.6], look_at: [0.72, 1.0, 0.0], fov_radians: 0.82 },
        "first_person_contact" => CameraMode { eye: [-0.68, 1.4, 0.3], look_at: [0.68, 0.9, 0.0], fov_radians: 0.88 },
        "first_person_recovery" => CameraMode { eye: [-0.72, 1.4, 0.7], look_at: [0.72, 1.2, 0.0], fov_radians: 0.80 },
...
impl InteractiveState {
    ...
    fn camera_mode(self) -> &'static str {
        match self {
            ...
            Self::Observe => "first_person_combat_view",
            Self::Timeline => "first_person_anticipation",
            Self::Plan => "planning_timeline",
            Self::CommitReveal => "first_person_contact",
            Self::Resolve => "first_person_contact",
            Self::Consequence => "first_person_recovery",
