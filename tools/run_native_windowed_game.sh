...
longsword = root / "assets/presentation_runtime/longsword.mesh.json"
gambeson = root / "assets/presentation_runtime/gambeson.mesh.json"
tex = root / "assets/model_candidates/t_73291be5/textures"
def tex_paths(name):
    return {
        "base_color_texture_path": str(tex / f"{name}_base.png"),
        "normal_texture_path": str(tex / f"{name}_normal.png"),
        "orm_texture_path": str(tex / f"{name}_orm.png"),
    }
...
meshes = [
    {"mesh_asset_id":"player_saltreach_duelist","mesh_asset_class":"fighter","mesh_source":str(skinned),
     ...
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **saltreach_tex},
    {"mesh_asset_id":"opponent_saltreach_duelist","mesh_asset_class":"fighter","mesh_source":str(skinned),
     "translation":[0.72,0.0,0.0],"scale":0.72,"yaw_radians":0.10,
     "transform_baked_or_runtime":"runtime_transform_baked_into_candidate_vertex_buffer",
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **saltreach_tex},
    {"mesh_asset_id":"player_gambeson","mesh_asset_class":"armor","mesh_source":str(gambeson),
     "translation":[-0.72,0.18,0.00],"scale":0.14,"yaw_radians":0.10,
     "transform_baked_or_runtime":"runtime_transform_baked_into_candidate_vertex_buffer",
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **gambeson_tex},
    {"mesh_asset_id":"opponent_gambeson","mesh_asset_class":"armor","mesh_source":str(gambeson),
     "translation":[0.72,0.18,0.00],"scale":0.14,"yaw_radians":0.10,
     "transform_baked_or_runtime":"runtime_transform_baked_into_candidate_vertex_buffer",
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **gambeson_tex},
    {"mesh_asset_id":"player_longsword","mesh_asset_class":"weapon","mesh_source":str(longsword),
     "translation":[-1.02,0.42,-0.04],"scale":0.34,"yaw_radians":1.35,
     "transform_baked_or_runtime":"runtime_transform_baked_into_candidate_vertex_buffer",
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **longsword_tex},
    {"mesh_asset_id":"opponent_longsword","mesh_asset_class":"weapon","mesh_source":str(longsword),
     "translation":[1.02,0.42,-0.04],"scale":0.34,"yaw_radians":-1.35,
     "transform_baked_or_runtime":"runtime_transform_baked_into_candidate_vertex_buffer",
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **longsword_tex},
    {"mesh_asset_id":"training_yard","mesh_asset_class":"arena","mesh_source":str(training),
     "translation":[0.0,-0.30,0.35],"scale":0.50,"yaw_radians":0.0,
     "transform_baked_or_runtime":"runtime_transform_baked_into_candidate_vertex_buffer",
     "candidate_status":"source_approved_production_seed","production_ready":False,"truth_mutation":False, **training_tex},
]
