...
if [[ -f assets/manifests/presentation_manifest.json ]]; then
...
manifest = {
    ...
    'production_candidate_visual_assets_complete': Path('assets/manifests/production_candidate_visual_manifest.json').is_file(),
